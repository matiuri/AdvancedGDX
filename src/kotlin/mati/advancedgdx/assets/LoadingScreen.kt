 ...
 */
open class LoadingScreen(game: AdvancedGame, protected val manager: AssetManager,
                         protected val after: () -> Unit) : Screen<AdvancedGame>(game) {
    override fun show() {
    ...
    /**
     * This method is essential. If you override it, you must call "super.hide()"
     */
    override fun hide() {
